...
/**
 * @Author:LiuWei
 * @Description:  mybatisplus自动根据数据库的表生成部分代码，包括，entity、mapper(接口和mapper.xml)、service、controller
 * @Date: Created in 16:27 2019/4/19
 * @Modified By:
 */
public class MabatisPlusGenerator {
    ...
    static{
        baseProjectPath = System.getProperty("user.dir")+"/deepeye-api/";
    }

    //基本包名
    private static String basePackage = "com.intellif.ifaas.api";
    //作者
    private static String authorName = "intellif";
    //要生成的表名
    private static String[] tables = {"t_video_db"};
    //table前缀
    ...
    private static String url = "jdbc:mysql://192.168.11.169:3306/ifaas_deepeye_api?useUnicode=true&characterEncoding=utf8&useSSL=false";
    private static String username = "root";
    private static String password = "introcks1234";

    //模块相关名称
    //controller包名
    private static String controllerName = "controller.search";
    //实体类包名
    private static String entity = "dto.entity";
    //mapper接口包名
